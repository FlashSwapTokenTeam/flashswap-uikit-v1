...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#191326", textDisabled: "#BDC2C4", textSubtle: "linear-gradient(90.32deg, #84080b 2.5%, #bc191d 99.8%)", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
